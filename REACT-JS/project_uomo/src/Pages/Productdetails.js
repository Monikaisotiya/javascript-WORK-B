      ...
      <main style={{ paddingTop: "90px" }}>
        ...
        <section class="product-single container">
          <div class="row">
            <div class="col-lg-7">
              <div
                class="product-single__media vertical-thumbnail product-media-initialized"
              ...
              >
                <div class="product-single__image">
                  ...
                  >
                    <div
                      ...
                      id="swiper-wrapper-2db827401a5bfcd4"
                      aria-live="polite"
                      style={{ transform: "translate3d(0px, 0px, 0px)" }}
                    >
                      <div
                        class="swiper-slide product-single__image-item swiper-slide-active"
                        role="group"
                        aria-label="1 / 4"
                        style={{ width: "684px", marginRight: "32px" }}
                      >
                        <img
                          loading="lazy"
                          class="h-auto"
                      ...
                      <div
                        class="swiper-slide product-single__image-item swiper-slide-next"
                        role="group"
                        aria-label="2 / 4"
                        style={{ width: "684px", marginRight: "32px" }}
                      >
                    ...
                    <div
                      ...
                      aria-controls="swiper-wrapper-2db827401a5bfcd4"
                      aria-disabled="true"
                    >
                      <svg
                        width="7"
                ...
                <div class="product-single__thumbnail">
                  <div class="swiper-container swiper-container-initialized swiper-container-vertical swiper-container-pointer-events swiper-container-free-mode swiper-container-thumbs">
                    <div
                      class="swiper-wrapper"
                      id="swiper-wrapper-4522e74490c6af44"
                      aria-live="polite"
                      style={{
                    ...
                    >
                      <div
                        class="swiper-slide product-single__image-item swiper-slide-active swiper-slide-thumb-active"
                        role="group"
                        aria-label="1 / 4"
                        style={{ height: "114px" }}
                      >
        ...
        <section class="products-carousel container">
          ...
          <div id="related_products" class="position-relative">
            <div
              class="swiper-container js-swiper-slider swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events"
              data-settings='{
            "autoplay": false,
            "slidesPerView": 4,
            "slidesPerGroup": 4,
            ...
            >
              <div
                class="swiper-wrapper"
                id="swiper-wrapper-da5c0851027c2a59c"
                aria-live="polite"
                style={{
              ...
              >
                <div
                  class="swiper-slide product-card swiper-slide-duplicate"
                ...
                <div
                  class="swiper-slide product-card swiper-slide-duplicate swiper-slide-prev"
                ...
                <div
                  class="swiper-slide product-card swiper-slide-active"
                ...
                <div
                  class="swiper-slide product-card swiper-slide-next"
                ...
                <div
                  class="swiper-slide product-card swiper-slide-duplicate-prev"
                  data-swiper-slide-index="7"
                  role="group"
                  aria-label="12 / 16"
                  style={{ width: "330px", marginRight: "30px" }}
                ...
                <div
                  class="swiper-slide product-card swiper-slide-duplicate swiper-slide-duplicate-active"
                  data-swiper-slide-index="0"
                  role="group"
                  aria-label="13 / 16"
                  style={{ width: "330px", marginRight: "30px" }}
                ...
                <div
                  class="swiper-slide product-card swiper-slide-duplicate swiper-slide-duplicate-next"
                  data-swiper-slide-index="1"
                  role="group"
                  aria-label="14 / 16"
                  style={{ width: "330px", marginRight: "30px" }}
            ...
            <div
              ...
              role="button"
              aria-label="Previous slide"
              aria-controls="swiper-wrapper-da5c0851027c2a59c"
            >
              <svg
                width="25"
                height="25"
            ...
            <div class="products-pagination mt-4 mb-5 d-flex align-items-center justify-content-center swiper-pagination-clickable swiper-pagination-bullets">
              <span
